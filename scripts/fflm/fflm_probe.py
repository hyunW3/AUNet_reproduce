...
_ROOT = os.environ.get("AUNET_ROOT", "/NHNHOME/WORKSPACE/0226010285_F/MINDlab/hyunw3/AUNet")
DEFAULT_TOK = os.environ.get("AUNET_TOK", f"{_ROOT}/tokenizer/llama3/tokenizer.model")
